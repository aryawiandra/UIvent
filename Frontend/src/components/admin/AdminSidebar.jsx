...
const AdminSidebar = ({ isOpen, onClose }) => {
  return (
    <>
      ...
      <div
        className={`sidebar fixed lg:static inset-y-0 left-0 bg-white shadow-lg z-30 
        ...
        <nav>
          <ul className="space-y-2">
            <li>
              <a
                href="#"
                className="flex items-center px-4 py-3 text-yellow-600 bg-yellow-100 rounded-lg"
              >
